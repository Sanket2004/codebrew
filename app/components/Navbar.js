    ...
    <nav className="bg-transparent py-2 px-4 fixed top-0 left-0 w-full z-50 shadow-sm backdrop-blur-xl flex justify-between items-center">
      <Link href={"/"}>
        <Image
          ...
          height={0}
          alt="CodeBrew Logo"
          className="w-32 h-2w-32 hover:brightness-50 transition-all hover:drop-shadow-xl"
        />
      </Link>
              ...
              <DrawerTitle>
                <Link href={"/"}>
                  <Image
                    ...
                    height={0}
                    alt="CodeBrew Logo"
                    className="w-28 h-2w-28 hover:brightness-50 transition-all hover:drop-shadow-xl"
                  />
                </Link>
              </DrawerTitle>
              <hr className="my-2" />
